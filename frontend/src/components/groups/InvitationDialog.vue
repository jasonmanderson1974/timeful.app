  ...
  >
    <v-expand-transition>
      ...
      >
        <v-card-text>
          <div
            class="tw-mb-5 tw-text-wrap tw-text-xl tw-font-medium tw-text-parchment"
          >
          ...
          <v-expand-transition>
            <div v-if="calendarPermissionGranted">
              ...
              <div class="tw-mt-5 tw-space-y-4">
                <div class="tw-font-medium tw-text-parchment">
          ...
          <v-expand-transition>
            <div class="tw-p-5 tw-text-parchment" v-if="!calendarPermissionGranted">
        ...
        <v-card-actions v-else>
          <v-dialog v-model="rejectDialog" width="400" persistent>
            <template v-slot:activator="{ on, attrs }">
              <v-btn text class="tw-text-parchment-dim" v-bind="attrs" v-on="on"
          ...
          <v-spacer />
          <v-btn
            class="tw-bg-brass tw-px-5 tw-text-white tw-transition-opacity"
            @click="acceptInvitation"
            :disabled="!calendarPermissionGranted"
